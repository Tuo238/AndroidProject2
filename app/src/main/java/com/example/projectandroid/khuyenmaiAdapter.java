...
public class khuyenmaiAdapter extends ArrayAdapter {

    Context context;
    ArrayList<khuyenmai> arrayList;
    int layout;

    public khuyenmaiAdapter(@NonNull Context context, int resource, @NonNull ArrayList<khuyenmai> objects) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        khuyenmai km = arrayList.get(position);
        if(convertView == null){
