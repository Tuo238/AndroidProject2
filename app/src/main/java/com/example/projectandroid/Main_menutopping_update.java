...
public class Main_menutopping_update extends AppCompatActivity {
    ListView lvtopping;
    Button btnupdate;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_main_menutopping_update);
        addControlls();
        addEvent();
        loadTopping();
    }
        ...
        query.get().addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
            ...
            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                if (task.isSuccessful()) {
                    ...
                    toppingAdapter = new ToppingAdapter(Main_menutopping_update.this, R.layout.layout_item_topping, arrayList);
